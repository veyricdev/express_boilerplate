      ...
      <Table>
        <TableHeader className='bg-muted/50'>
          <TableRow className='hover:bg-transparent border-b'>
            ...
            <TableHead className='w-[25%] px-6 py-4 font-bold text-foreground h-12 uppercase text-[11px] tracking-wider'>Người gửi</TableHead>
            <TableHead className='w-[40%] px-6 py-4 font-bold text-foreground h-12 uppercase text-[11px] tracking-wider'>Chủ đề</TableHead>
            <TableHead className='px-6 py-4 font-bold text-foreground h-12 uppercase text-[11px] tracking-wider'>Ngày gửi</TableHead>
                ...
                <TableCell className='px-6 py-5'>
                  <div className='flex flex-col gap-0.5'>
                    <div className='flex items-center gap-2'>
                      <Link to={`/contacts/${contact.id}`} className='font-bold text-foreground hover:text-primary transition-colors'>
                        {contact.fullName}
                      </Link>
                      {!contact.isRead && <Badge variant='secondary' className='text-[10px] h-5 bg-blue-100 text-blue-700 hover:bg-blue-200 border-transparent px-2'>Mới</Badge>}
                    </div>
